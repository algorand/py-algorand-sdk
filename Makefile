...
cucumber-unit:
	behave --tags=$(UNITS) test/cucumber -f progress2
...
cucumber-integration:
	behave --tags=$(INTEGS) test/cucumber -f progress2

unit: local-unit cucumber-unit

integration: local-integration cucumber-integration
